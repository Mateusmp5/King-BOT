...
exports.sticker = () => { return `❬❗❭ Isso é algo pra marcar em fotos, se quiser usar em videos ou gifs digite ${prefix}gif.` }
...
exports.genero = (seanl) => { return `O nome "${seanl.data.name}" é mais usado pra ${seanl.data.gender} \n (male = homem/Hombre, female = mulher/mujer).` }
...
║
║   *${prefix}updates*
║      ᐳ Veja as últimas atualizações do BOT.
║
║
║    ❗ Prefixo: 「 ! 」
║
