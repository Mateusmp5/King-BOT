...
exports.fbi = () => { return `❬❗❭ Agradecemos por denunciar um Lolicon!\nCaso você seja uma autoridade pode ser conveniente olhar nosso comando ${prefix}FBI.` }

exports.cia = () => { return `❬❗❭ Obrigado por denunciar uma pedofilia reversa!\nAs autoridades podem ver denuncias no ${prefix}CIA.` }

exports.stars = () => { return `❬❗❭ Malditos criminosos não é? Não se preocupe, vamos lidar com isso, por hora os policiais devem ver o ${prefix}STARS.` }

exports.bsaa = () => { return `❬❗❭ Agradecemos por denunciar um LGBT+, vamos analisar qual dos 10 mil gêneros ele usa e então postaremos no ${prefix}BSAA.` }

exports.arrested = () => { return `❬❗❭ Muito obrigado pela sua atenção e denúncia de si mesmo!\nEnviamos 5 viaturas armadas a sua casa!\nSua pena foi reduzida em alguns anos!\nInfelizmente, a cadeia está cheia de pessoas que odeiam pedófilos, boa sorte!\nOlhe o ${prefix}BSAA.` }

exports.policemenu = (pushname) => { return `

➣ Bem-vindo *${pushname}* as *Denúncias*

╔═👮 〘 𝐃𝐄𝐍𝐔𝐍𝐂𝐈𝐀𝐒 〙🚓═╗
║
║ ⚠️ - Capitão Asta, o que deseja?
║
║ *→ ${prefix}01 <@user>*
║ 	ᐳ Denuncie Lolicons, Shotacons, Trapcons, etc.
║
║ *→ ${prefix}02*
║ 	ᐳ Se entregue.
║
║ *→ ${prefix}03 <@user>*
║ 	ᐳ Denuncie Lolis, Shotas, Traps, etc
║
║ *→ ${prefix}04 <@user|crime>*
║ 	ᐳ Denuncie crimes de pessoas.
║
║ *→ ${prefix}05 <@user>*
║ 	ᐳ Denuncie os LGBT's.
║
║ *→ ${prefix}fbi*
║	ᐳ Veja os pedófilos denunciados.
║
║ *→ ${prefix}cia <Foto>*
║	ᐳ Veja os menores denunciados.
║
║ *→ ${prefix}rdp*
║ 	ᐳ Saiba quem se entregou.
║
║ *→ ${prefix}bsaa*
║ 	ᐳ Confira uma lista de LGBT'S denunciados.
║
║ *→ ${prefix}stars*
║	ᐳ Uma lista de crimes reportados.
║
║ *→ ${prefix}resetall*
║	ᐳ Reseta todos os crimes e denuncias.
║
╚══〘 𝐀𝐒𝐓𝐀 𝐁𝐎𝐓 〙══╝ ` }

exports.howtololi = () => { return `❬❗❭ Para denunciar um Lolicon Pedófilo use ${prefix}01 <@User>.\nExemplo: /01 @Esguicho.` }

exports.howtoshota = () => { return `❬❗❭ Para denunciar uma Loli, trap, shota ou outros use ${prefix}03 <@User>.\nExemplo: /03 @Ana.` }

exports.howtocrime = () => { return `❬❗❭ Para denunciar crimes use ${prefix}04 (@User|Crime).\nPor exemplo: ${prefix}04 @Esguicho | Rouba dinheiro de lolis grávidas.` }

exports.howtolgbts = () => { return `❬❗❭ Para denunciar LGBT'S+, use ${prefix}05 <@User>.\nExemplo: ${prefix}05 @Esguicho.` }

exports.gifail = () => { return `❬❗❭ Esse GIF ao ser convertido se tornou pesado demais pra enviar, tente enviar uma versão mais curta!` }

exports.upfail = () => { return `❬❗❭ O servidor negou o upload da foto, tente novamente dentro de uns minutos!` }

exports.kickcount = () => { return `❬❗❭ Para que você use, adicione uma quantidade minima de mensagens que as pessoas devem ter na frente do comando.\n\n⚠️ - Esse sistema é beta e só conta mensagens quando a BOT está ligada, certifique-se de que sua BOT seja 24 horas ativa para ter uma remoção justa.` }
...
exports.sticker = () => { return exports.sticker = () => { return `❬❗❭ Isso é algo pra marcar em fotos, se quiser usar em videos ou gifs digite ${prefix}gif.` }
...
exports.gpadulto = () => { return `Aqui não permitimos safadezas e impurezas 😡, caso um administrador queira permitir, use ${prefix}nsfw enable, ou você pode usar no PV.` }
...
exports.entrace = () => { return `❬❗❭ Foi mal meu amigo, mas você acaba de ser barrado pelo gerente do estabelecimento 😎` }
...
exports.bye = (pushname) => { return `Adeus ${pushname}, você foi ou seria um excelente amigo(a) e membro.` }
...
exports.death = (predea) => { return `❬❗❭ Pessoas com este nome "${predea.data.name}" tendem a morrer aos ${predea.data.age} anos de idade.` }

exports.oculto = (surp, surp2) => { return `*EQUIPE ❌VIDEOS*\n\n_Caro usuário @${surp.id.replace(/@c.us/g, '')} ..._\n\n_Sou da administração do Xvideos e nós percebemos que você não entrou em sua conta por mais de 2 semanas e decidimos checar pra saber se está tudo OK com o(a) nosso(a) usuário(a) mais ativo(a)._ \n\n_Desde a última vez que você visitou nosso site, você procurou mais de centenas de vezes por_ *"${surp2}"* _(acreditamos ser sua favorita), viemos dizer que elas foram adicionadas e temos certeza que você irá gostar bastante._ \n_Esperamos você lá!_\n\n_Para o nosso usuário(a) favorito(a), com carinho, Equipe Xvideos._` }

exports.genero = (seanl) => { return `❬❗❭ O nome "${seanl.data.name}" é mais usado para ${seanl.data.gender}\n(male = homem/Hombre, female = mulher/mujer).` }

exports.gostosa = (quem) => { return `*ＤＥＴＥＣＴＯＲ   ＤＥ  ＧＯＳＴＯＳＡＳ👩‍⚕️*\n\n*pi pi pi pi*  \n*pipipipi🚨🚨🚨pipipipi🚨🚨🚨pipipipi🚨🚨🚨pipi*\n\n@${quem.id.replace(/@c.us/g, '')} *PARADA(O) AÍ🖐*\n\n*VOCÊ ACABA DE RECEBER DUAS MULTAS*\n\n*1 por não dar Bom dia/Boa tarde/Boa noite e outra por ser muito*\n\n*gostosa(o)*\n\n*valor da multa:*\n*FOTO DA TETINHA NO PV kkkkk*` }

exports.contar = (body, args) => { return `❬❗❭ Isso contém ${body.slice(8).length} letras e ${args.length} palavras.` }
...
exports.polliv = () => { return `😡 - Malditos cheaters! Nunca se cansam de tentar burlar nossos joguinhos? Estarei de olho em você!` }
...
exports.broad = () => { return `❬❗❭ Para usar isso, digite o comando, em seguida defina se quer todos[-all], grupos[-gps] ou privados[-pvs] e em seguida a sua mensagem de transmissão, se quiser mandar mídia marque a mensagem com ela.` }
...
👥 - *${chatIds.length - groups.length}* Conversas no 
...
exports.lovepv = (arqs, lvpc) => { return `A chance de você namorar a consagrada ${arqs[1]} é de ${lvpc}%. 👩‍❤️‍👨` }

exports.love = (arqs, lvpc) => { return `${arqs[1]} a sua chance de namorar a morena ${arqs[2]} é de ${lvpc}%. 👩‍❤️‍👨` }

exports.lgbt = (lvpc, guei, lvrq, twgui) => { return `🌈 - Com certeza é ${lvpc}% ${guei} e ${lvrq}% ${twgui}!` }

exports.botmonkey = (body, lvpc) => { return `_De acordo com meus calculos super avançados de ~macaco~ Robô a chance de..._ \n\n*"${body.slice(8)}"*\n\n_...ser realidade é de_ *${lvpc}%.*` }
...
exports.gainxp = (userGainXp, theXPtoAdd) => { return `❬❗❭ O player @${userGainXp} recebeu a quantidade de ${theXPtoAdd} XP.` }
...
exports.stickers = (pushname, time) => { return `

➣ Bem-vindo *${pushname}* aos comandos de *Stickers*!

	Data: *${time}*

╔═🏖️〘 𝐒𝐓𝐈𝐂𝐊𝐄𝐑𝐒 〙🏖️═╗
║
║ *→ ${prefix}sticker <Imagem>*
║ 	ᐳ Pra transformar uma imagem em figurinha.
║
║ *→ ${prefix}gif <Video | GIF>*
║ 	ᐳ Stickers usando gifs e videos.
║
║ *→ ${prefix}toimg <Sticker>*
║ 	ᐳ Respondendo uma figurinha, transforme ela em imagem.
║
║ *→ ${prefix}ttp (Mensagem)*
║ 	ᐳ Transforme frases em stickers.
║
║ *→ ${prefix}attp (Mensagem)*
║ 	ᐳ Crie sticker animados por frases.
║
║ *→ ${prefix}emoji <Emoji>*
║	ᐳ Faça stickers de 10+ tipos de emoji.
║
║ *→ ${prefix}nobg <Foto>*
║	ᐳ Esse faz stickers sem fundo!
║
║
╚══〘 𝐀𝐒𝐓𝐀 𝐁𝐎𝐓 〙══╝` }
...
║   	ᐳ Em caso de dúvidas/erros.
║
║   *${prefix}ping*
║      ᐳ Pra mostrar o Ping/Velocidade do BOT.
║
║    ❗ Prefixo: 「 ! 」
║
╚════════════════╝
...
╔══📌〘 𝐂𝐎𝐌𝐀𝐍𝐃𝐎𝐒 〙📌══╗
║
║ ⚠️ *- Não floode senão os comandos podem cair!*
║ 
║ ⚠️ *- Se falhar, o servidor caiu temporariamente.*
║
║ 🏖️ *→ ${prefix}stickers*
║	ᐳ Comandos que usam stickers.
║
║ 🌐 *→ ${prefix}down* 
║	ᐳ Comandos de Downloads.
║
║ 🧑🏼‍💻 *→ ${prefix}admins* 
║	ᐳ Comandos para administradores.
║
║  🎰 *→ ${prefix}games*
║	ᐳ Mini-Jogos para jogar!
║
║  🔞 *→ ${prefix}adult*
║	ᐳ Lista de comandos +18!
║
║ 🖨️ *→ ${prefix}maker*
║	ᐳ Fabrica de imagens!
║
║ 🇯🇵 *→ ${prefix}otaku*
║	ᐳ Lista de comandos de Anime!
║
║🚪 *→ ${prefix}outros*
║	ᐳ Outros comandos!
║
...
exports.down = (pushname, time) => { return `

➣ Bem-vindo *${pushname}* aos comandos de *Downloads*!
...
║
║ *→ ${prefix}!play <Nome>*
║	ᐳ Baixe musicas do YouTube pelo nome.
║
║ *→ ${prefix}video <Nome>*
║	ᐳ Baixe videos do YouTube pelo nome.
║
║ *→ ${prefix}mp3 <Link de YouTube>*
║	ᐳ Baixe música por Links do YouTube.
║
║ *→ ${prefix}mp4 <Link de YouTube>*
║	ᐳ Baixe videos por Links do YouTube.
║
║ ️*→ ${prefix}fb <Link de Facebook>*
║	ᐳ Baixe videos por Links do Facebook.
║
║ *→ ${prefix}ytsearch <nome>*
║	ᐳ Busque videos para usar no !mp3/mp4.
║
║ *→ ${prefix}letra <nome da música>*
║	ᐳ Busque letras de música.
║
╚══〘 𝐀𝐒𝐓𝐀 𝐁𝐎𝐓 〙══╝` }
...
║
║ *→ ${prefix}mute <On/Off>*
║	ᐳ Impede de chamarem o barman AbismoBOT.
║
║ *→ ${prefix}welcome <On/Off>*
║	ᐳ Ative o meu modo garçom.
║
║ *→ ${prefix}rank <On/Off>*
║	ᐳ Ative a "sinuca" virtual pros clientes!
║
...
║	ᐳ Stickers fotos/videos/GIF automaticos.
║
...
exports.games = (pushname, time) => { return `

➣ Bem-vindo *${pushname}* aos comandos de *Games*!
...
║	ᐳ Jogue a roleta para ganhar XP. ou perder...
║
║ *→ ${prefix}roleta <valor>*
║	ᐳ Jogue Roleta-Russa para ganhar ou perder XP.
║
║ *→ ${prefix}roll*
║	ᐳ Jogo de dados, sem XP.
║
║ *→ ${prefix}flip <cara/coroa> <valor>*
║	ᐳ O classico cara ou coroa.
║
║ *→ ${prefix}level*
║	ᐳ Pegue seu XP em formato Discord.
║
║ *→ ${prefix}nivel*
║	ᐳ Adquira seu XP e outros em forma de texto.
║
║ *→ ${prefix}ranking*
║	ᐳ Veja os 10 melhores players. (do grupo)
║
║ *→ ${prefix}geral*
║	ᐳ Veja o rank geral. (todos grupo do bot)
║
║ *→ ${prefix}store <nome>*
║	ᐳ Procure jogos e apps na Play-Store.
║
║ ️*→ ${prefix}akinator*
║	ᐳ Jogue akinator, intruções vem depois.
║
║ ️*→ ${prefix}kiss <@user>*
║	ᐳ Que tal beijar a morena(o)?
║
║ ️*→ ${prefix}ship <@user @user>*
║	ᐳ Quer saber o quanto seus amigos combinam?
║
║ ️*→ ${prefix}slap <@user>*
║	ᐳ Vamos dar um tapasso nos outros!
║
║ ️*→ ${prefix}gado <@user>*
║	ᐳ Veja o quanto ela é gada.
║
║ ️*→ ${prefix}gay <@user>*
║	ᐳ Veja o quanto ela é gay.
║
║ ️*→ ${prefix}chance <algo>*
║	ᐳ Quer que eu calcule as chances?
║
║ ️*→ ${prefix}detector*
║	ᐳ Detecta gostosas no grupo.
║
║ ️*→ ${prefix}piada*
║	ᐳ Conta uma piada.
║
...
exports.maker = (pushname, time) => { return `

➣ Bem-vindo *${pushname}* aos comandos *Maker!
...
║
║
║ *→ ${prefix}blur <@user/mensagem|foto>*
║	ᐳ Desfoca as imagens.
║
║ *→ ${prefix}light <Frase>*
║	ᐳ Uma logo de neon em luz.
║
║ *→ ${prefix}quote <frase|autor>*
║	ᐳ Crie sua propria frase.
║
║ *→ ${prefix}make <frase>*
║	ᐳ Escreva no meu diario Death Note.
║
║ *→ ${prefix}slogan <Nome>*
║	ᐳ Faça slogans bonitinhos.
║
║ *→ ${prefix}3D <texto>*
║	ᐳ Crie textos em 3D.
║
║ ️*→ ${prefix}logo <nome>*
║	ᐳ Crie logos em preto e pink.
║
║ ️*→ ${prefix}gaming <nome>*
║	ᐳ Crie logos de jogador.
║
║ ️*→ ${prefix}pornhub <texto 1|texto 2>*
║	ᐳ Crie sua propria logo do PornHub.
║
║ ️*→ ${prefix}thunder <frase>*
║	ᐳ Uma logo do céu com trovões.
║
║ ️*→ ${prefix}wolf <Frase1|Frase2>*
║	ᐳ Logo de Lobos.
║
║ ️*→ ${prefix}neon <Frase1|Frase2|Frase3>*
║	ᐳ Uma logo de neon estilo hackerman.
║
║ ️*→ ${prefix}wasted <foto>*
║	ᐳ Cria uma imagem de wasted igual ao GTA V.
║
║ ️*→ ${prefix}gtav <foto>*
║	ᐳ Crie a capa do novo GTA V de PS2.
║
║ ️*→ ${prefix}reverter <foto>*
║	ᐳ Reverta uma foto.
║
║ ️*→ ${prefix}phcom <Username|Comentário|Foto>*
║	ᐳ Falsifique comentários no PornHub.
║
║ ️*→ ${prefix}ytcom <Username|Comentário|Foto>*
║	ᐳ Falsifique comentários no YouTube.
║
║ ️*→ ${prefix}water <frase>*
║	ᐳ Crie logos em água.
║
║ ️*→ ${prefix}trigger <frase>*
║	ᐳ Triggered 😡.
║
║ ️*→ ${prefix}hitler <@user/mensagem|foto>*
║	ᐳ 卍 Hitler!
║
║ ️*→ ${prefix}trash <@user/mensagem|foto>*
║	ᐳ Faça um meme sobre lixo.
║
║ ️*→ ${prefix}shit <@user/mensagem|foto>*
║	ᐳ Eca, coco!
║
║ ️*→ ${prefix}rip <@user/mensagem|foto>*
║	ᐳ Rip, F.
║
║ ️*→ ${prefix}retro <Frase1|Frase2|Frase3>*
║	ᐳ Logos retro das antigas.
║
║ ️*→ ${prefix}meme <Foto|Frase1|Frase2>*
║	ᐳ Faça memes pelo WhatsApp.
║
╚══〘 𝐀𝐒𝐓𝐀 𝐁𝐎𝐓 〙══╝` }

exports.anime = (pushname, time) => { return `

➣ Bem-vindo *${pushname}* aos comandos de *Animes*!
...
║
║ *→ ${prefix}anime [nome]*
║	ᐳ Com isso você pesquisa um anime
║
║ *→ ${prefix}search (Foto)*
║ 	ᐳ Pesquisar prints para achar o nome do anime.
║
║ *→ ${prefix}loli*
║	ᐳ Lolis são pra dar amor e carinho...
║
║ *→ ${prefix}waifu*
║	ᐳ Com isso eu mando foto de waifus lindas.
║
║ *→ ${prefix}husb*
║	ᐳ Com isso eu mando foto de husb.
║
║ *→ ${prefix}neko*
║	ᐳ Bom...uma neko as vezes cai bem né?
║
║ *→ ${prefix}randomanime*
║	ᐳ Enviarei fotos aleatorias de anime.
║
║ ️*→ ${prefix}randomwall*
║	ᐳ Wallpapers de personagens
║
║ ️*→ ${prefix}pokemon*
║	ᐳ Um Pokemon aleatorio.
║
║ ️*→ ${prefix}hug*
║	ᐳ Da abraço com personagens de anime.
║
║ ️*→ ${prefix}baguette*
║	ᐳ Já é hora do meu pãozinho?!
║
║ ️*→ ${prefix}yuri*
║	ᐳ Duas garotas se "pegando" sem +18!.
║
║ ️*→ ${prefix}baka*
║	ᐳ "Bakaaa!"
║
║ ️*→ ${prefix}cocegas*
║	ᐳ Hmmm, cocegas em anime eu acho...
║
║ ️*→ ${prefix}food*
║	ᐳ Eventos que tem haver com comida em animes.
║
║ ️*→ ${prefix}poke*
║	ᐳ Tome uns petelecos!
║
║ ️*→ ${prefix}cafune*
║	ᐳ Todos amamos cafune...
║
║ ️*→ ${prefix}kisu*
║	ᐳ Umas fotinhas de beijo...
║
║ ️*→ ${prefix}tapa*
║	ᐳ Fotos de tapinhas!
║
...
║
║ ️*→ ${prefix}icon*
║	ᐳ Icones para por no perfil.
║
║ ️*→ ${prefix}face*
║	ᐳ Icon do rosto de garotas de anime.
║
║ ️*→ ${prefix}yaoi*
║	ᐳ Yaoi sem hentai.
║
║ ️*→ ${prefix}look*
║	ᐳ Olhos na tela eheheh
║
║ ️*→ ${prefix}holo*
║	ᐳ Fotinhas da personagem Holo.
║
╚══〘 𝐀𝐒𝐓𝐀 𝐁𝐎𝐓 〙══╝` }

exports.adult = (pushname, time) => { return `

➣ Bem-vindo *${pushname}* aos comandos *Adult*!
...
║
║ *→ ${prefix}randomneko*
║	ᐳ Hentai de nekos por aqui e.e
║
║ *→ ${prefix}ihentai*
║	ᐳ Temos aleatorios também!
║
║ *→ ${prefix}trap*
║	ᐳ Se você gosta de traps, isso é pra você e.e
║
║ *→ ${prefix}blowjob*
║	ᐳ Fotinhas de BlowJob em anime.
║
║ *→ ${prefix}iecchi*
║	ᐳ Umas fotos de ecchi que tenho aqui...
║
║ ️*→ ${prefix}feet*
║	ᐳ Hentai para os amantes de pezinho.
║
║ ️*→ ${prefix}lick*
║	ᐳ "Lambidinha..."
║
║ ️*→ ${prefix}femdom*
║	ᐳ Meio que um yuri...hentai...
║
║ ️*→ ${prefix}futanari*
║	ᐳ Vai uma futanari?
║
...
║
║ ️*→ ${prefix}masturb*
║	ᐳ Hmmm, garotas sozinhas...
║
║ ️*→ ${prefix}anal*
║	ᐳ Hentai "padrão" de anal.
║
║ ️*→ ${prefix}NSFWIcon*
║	ᐳ Foto de perfil +18 por aqui...
║
║ ️*→ ${prefix}randomloli*
║	ᐳ Hentai do tipo Lolicon.
║
║ ️*→ ${prefix}hard*
║	ᐳ Hentai de diciplinação.
║
║ ️*→ ${prefix}pezinho*
║	ᐳ Fotos de pezinho.
║
...
║
║ ️*→ ${prefix}lesbian*
║	ᐳ Lesbicas reais se pegando.
║
║ ️*→ ${prefix}pgay*
║	ᐳ Pornografia gay para quem curte.
║
║ ️*→ ${prefix}tits*
║	ᐳ Fotos de peitos reais.
║
║ ️*→ ${prefix}bdsm*
║	ᐳ Fotos BDSM.
║
...
║
║ ️*→ ${prefix}pussy*
║	ᐳ Belas maças cortadas pela metade...
║
║ ️*→ ${prefix}ass*
║	ᐳ Bundas...
║
║ ️*→ ${prefix}xvideos <link>*
║	ᐳ Baixe pornografia do xvideos.
║
╚══〘 𝐀𝐒𝐓𝐀 𝐁𝐎𝐓 〙══╝` }

//exports.dados = () => { return `╭───「 ❗ Comandos Informativos 📖 」\n│\n│ 📍 - *1° → ${prefix}SIP <IPV4>*\n│ ᐳ _Posso conseguir informações de um IP._\n│\n│ 🗺️ - *2° → ${prefix}SCEP <CEP>*\n│ ᐳ _Posso pesquisar sobre um CEP._\n│\n│ 📱 - *3° → ${prefix}MAC <MAC>*\n│ ᐳ _Com isso eu pesquiso a marca do MAC._\n│\n│ 🚗 - *4° → ${prefix}Placa <aaa1111>*\n│ ᐳ _Puxe informações de veiculos._\n│\n│ 🏢 - *5° → ${prefix}SCNPJ <CNPJ>*\n│ ᐳ _Puxe dados de um CNPJ._\n│\n│ 🏅 - *6° → ${prefix}Criador*\n│ ᐳ _Conheça o carinha legal que me construiu!_\n│\n│ 🏓 - *7° → ${prefix}Ping*\n│ ᐳ _Minhas informações._\n│\n│ ℹ️ - *8° → ${prefix}GroupInfo*\n│ ᐳ _Veja algumas informações desse grupo._\n│\n│ 🍺 - *9° → ${prefix}Link*\n│ ᐳ _Obtenha o link desse bar._\n│\n│ 👷🏼 - *10° → ${prefix}ADMS*\n│ ᐳ _Chame ou saiba quem são os gerentes._\n│\n│ 🆔 - *11° → ${prefix}ID*\n│ ᐳ _Adquira a ID do buteco._\n│\n│ 🚪 - *12° → ${prefix}Grupos*\n│ ᐳ _Pega as IDs de todos os grupos._\n│\n│ 👨🏻‍🍳 - *13° → ${prefix}Chefe*\n│ ᐳ _Saiba sobre o dono do grupo._\n│\n│ 📩 - *14° → ${prefix}Wame <@user/mensagem>*\n│ ᐳ _Crie wame de pessoas._\n│\n│ 📆 - *15° → ${prefix}Data*\n│ ᐳ _Data do sistema._\n│\n│ 🗣️ - *16° → ${prefix}Idiomas*\n│ ᐳ _Informa as linguas do TTS._\n│\n│ 🔄 - *17° → ${prefix}Marcar*\n│ ᐳ _Marca você (copie e cole)._\n│\n│ 🧬 - *18° → ${prefix}Gender <nome>*\n│ ᐳ _Saiba o gênero pelo nome._\n│\n│ ☠️ - *19° → ${prefix}Death <nome>*\n│ ᐳ _Calcularei a idade de morte dela._\n│\n│ 🧮 - *20° → ${prefix}Contar <mensagem>*\n│ ᐳ _Calcule letras e palavras da mensagem._\n│\n│ 🔙 - *21° → ${prefix}Inverter <mensagem>*\n│ ᐳ _Inverta as mensagens._\n│\n│ 🔍 - *22° → ${prefix}Google <pesquisa>*\n│ ᐳ _Pesquise coisas no Google._\n│\n│ 🎒 - *23° → ${prefix}Brainly <pergunta>*\n│ ᐳ _Pesquise no Brainly._\n│\n│ 🕵🏼 - *24° → ${prefix}StalkIG <username>*\n│ ᐳ _Stalkeie alguém do Instagram._\n│\n│ 🗺️ - *25° → ${prefix}Maps <local>*\n│ ᐳ _Mostra o mapa de um local._\n│\n│ 🌤️ - *26° → ${prefix}Clima <cidade>*\n│ ᐳ _Saiba sobre o clima atual da sua cidade._\n│\n│ 🛰️ - *27° → ${prefix}Nasa -data <ano/mês/dia>*\n│ ᐳ _Obtenha informações da nasa._\n│\n│ #️⃣ - *28° → ${prefix}Conv -h*\n│ ᐳ _Converta temperatura ou distância._\n│\n│ 🧾 - *29° → ${prefix}Fatos*\n│ ᐳ _Conta fatos de animais._\n│\n│ 💬 - *30° → ${prefix}Curiosidade [-g] <algo>*\*\n│ ᐳ _Conta curiosidades em geral._\n│\n│ 💱 - *31° → ${prefix}Valor <Moeda/Quantia/Moeda>*\n│ ᐳ _Converta o valor monetário._\n│\n│ 🪙 - *32° → ${prefix}Coins*\n│ ᐳ _Lista de sigla de moedas.\n│\n│ 💭 - *33° → ${prefix}Trecho [-g] <nome>*\n│ ᐳ _Frases filosóficas de pessoas._\n│\n│ 🎼 - *34° → ${prefix}Letra <nome da música>*\n│ ᐳ _Busque letras de música._\n│\n│ 0️⃣ - *35° → ${prefix}Encode <mensagem>*\n│ ᐳ _Converta frases e números para Binario._\n│\n│ 1️⃣ - *36° → ${prefix}Decode <nome>*\n│ ᐳ _Traduza códigos em Binario._\n│\n│ 🦠 - *37° → ${prefix}Covid <País em Inglês>*\n│ ᐳ _Obtenha os casos do Covid-19._\n│\n│ 🎏 - *38° → ${prefix}Paises*\n│ ᐳ _Lista de países em inglês._\n│\n│ 🔙 - *39° → ${prefix}Encurtar <link>*\n│ ᐳ _Encurte links e SEM propagandas._\n│\n│ 🦀 - *40° → ${prefix}Signo <signo>*\n│ ᐳ _Adquira o horoscopo do dia (Ganesha)._\n│\n│ 🤔 - *41° → ${prefix}Translate <sigla/frase>*\n│ ᐳ _Traduza mensagens para outros idiomas._\n│\n│ ⏰ - *42° → ${prefix}Alarme*\n│ ᐳ _Programe um alarme pra te lembrar.\n│\n│ 📚 - *43° → ${prefix}Book*\n│ ᐳ _Busque por livros._\n│\n│ 🌟 - *44° → ${prefix}Frase*\n│ ᐳ_Deseja frases inspiradoras ou zoadas?._\n│\n│ 👛 - *45° → ${prefix}CPF <CPF>*\n│ ᐳ _Saiba somente o nome do dono dele._\n│\n╰───────────────────` }

//exports.midia = () => { return `╭───「 💽 Comandos Gerais de Mídia 🎥 」\n│\n│ 🐶 - *1° → ${prefix}Dog*\n│ ᐳ _Você adora cachorrinhos? Pois eu amo!_\n│\n│ 😆 - *2° → ${prefix}GetMeme*\n│ ᐳ _Por que não curtir uns memes né?_\n│\n│ 🖼️ - *3° → ${prefix}Wallpaper (nome)*\n│ ᐳ _Quer obter uns wallpapers? Deixe comigo!_\n│\n│ 🖨️ - *4° → ${prefix}Screenshot*\n│ ᐳ _Posso mostrar o site por dentro!_\n│\n│ 👱🏻‍♀️ - *5° → ${prefix}Girl*\n│ ᐳ _Quer uma garota bonitinha?_\n│\n│ 🦊 - *6° → ${prefix}Fox*\n│ ᐳ _Raposinhas bonitas (Não é o Kurama!)._\n│\n│ 🏗️ - *7° → ${prefix}Image <nome>*\n│ ᐳ _Pesquise coisas no Pinterest._\n│\n│ 🐱 - *8° → ${prefix}Gato*\n│ ᐳ _Gatos velho, simplesmente gatos!._\n│\n│ 📠 - *9° → ${prefix}Send <link>* \n│ ᐳ _Receba as fotos de um link._\n│\n│ 🦧 - *10° → ${prefix}Macaco*\n│ ᐳ _Pegue umas fotos de macacos aqui._\n│\n│ ❓ - *11° → ${prefix}SIMG <foto>*\n│ ᐳ _Pesquise imagens no Google._\n│\n│ 🔝 - *12° → ${prefix}UPIMG <foto>*\n│ ᐳ _Upe imagens por 1 semana._\n│\n│ 🦎 - *13° → ${prefix}Lizard*\n│ ᐳ _Vai uma largatixa level 99?_\n│\n│ 🦆 - *14° → ${prefix}Quack*\n│ ᐳ _Patos...ou ganços?._\n│\n│ 👧🏻 - *15° → ${prefix}PTT <audio>*\n│ ᐳ _Posso regravar audios como meus._\n│\n│ 📠 - *16° → ${prefix}Reedit <nome>*\n│ ᐳ _Obtenha publicações de algum subreedit._\n│\n│ 🔈 - *17° → ${prefix}TTS <Sigla/Frase>*\n│ ᐳ _Eu também posso fazer mimica! Por voz!_\n│\n│ 💋 - *18° → ${prefix}Kiss <@user>*\n│ ᐳ _Que tal beijar a morena(o)?_\n│\n│ 👏🏻 - *19° → ${prefix}Slap <@user>*\n│ ᐳ _Vamos dar um tapasso nos outros!_\n│\n│ 🎤 - *20° → ${prefix}Speak [-g] <mensagem>*\n│ ᐳ _Vamos conversar por voz?_\n│\n│ ⬇️ - *21° → ${prefix}GET <arquivo>*\n│ ᐳ _Receba de volta um arquivo enviado._\n│\n│ 👓 - *22° → ${prefix}Blur <@user/mensagem|foto>*\n│ ᐳ _Desfoca as imagens._\n│\n│ 🔊 - *23° → ${prefix}Sound [Audio/Quantidade]*\n│ ᐳ _Aumente ou diminua grave/bass._\n│\n│ ⚡ - *24° → ${prefix}Nightcore <Audio>*\n│ ᐳ _Faça músicas Nightcore._\n│\n│ 📻 - *25° → ${prefix}Audio <Video>*\n│ ᐳ _Pegue o audio de um video._\n│\n╰───────────────────` }

exports.outros = (pushname, time) => { return `

➣ Bem-vindo *${pushname}* aos comandos de *Outros*!
...
║
║ *→ ${prefix}poll
║ ᐳ Verifique enquentes ativas.
║
║ *→ ${prefix}vote (número)
║ ᐳ Vote numa enquete, se estiver tendo uma...
║
║ *→ ${prefix}NewPoll (nome)
║ ᐳ Crie uma enquete para os outros votarem.
║
║ *→ ${prefix}ins (nome)
║ ᐳ Adicione opções de voto na enquete.
║
║ *→ ${prefix}wallpaper (nome)*
║	ᐳ Quer obter uns wallpapers? Deixe comigo!
║
║ *→ ${prefix}image <nome>*
║	ᐳ Pesquise coisas no Pinterest.
║
║ *→ ${prefix}tts <Sigla/Frase>*
║	ᐳ Áudio do google tradultor!
║
║ *→ ${prefix}idiomas*
║	ᐳ Informa as linguas do TTS.
║
║ *→ ${prefix}math <expressão>*
║	ᐳ Realiza cálculos matemáticos.
║
║ *→ ${prefix}groupinfo*
║	ᐳ Veja algumas informações desse grupo.
║
║ ️*→ ${prefix}link*
║	ᐳ Obtenha o link desse bar.
║
║ ️*→ ${prefix}adms*
║	ᐳ Chame ou saiba quem são os gerentes.
║
║ ️*→ ${prefix}chefe*
║	ᐳ Saiba sobre o dono do grupo.
║
║ ️*→ ${prefix}wame <@user/mensagem>*
║	ᐳ Crie wame de pessoas.
║
║ ️*→ ${prefix}gender <nome>*
║	ᐳ Saiba o gênero pelo nome.
║
║ ️*→ ${prefix}death <nome>*
║	ᐳ Calcularei a idade de morte dela.
║
║ ️*→ ${prefix}contar <mensagem>*
║	ᐳ Calcule letras e palavras da mensagem.
║
║ ️*→ ${prefix}inverter <mensagem>*
║	ᐳ Inverta as mensagens.
║
║ ️*→ ${prefix}stalkig <username> [MANUTENÇÃO]*
║	ᐳ Stalkeie alguém do Instagram
║
║ ️*→ ${prefix}signo <signo>*
║	ᐳ Adquira o horoscopo do dia (Ganesha).
║
║ ️*→ ${prefix}frase*
║	ᐳDeseja frases inspiradoras ou zoadas?.
║
║ *→ ${prefix}ptt <audio>*
║	ᐳ Posso regravar audios como meus.
║
║ *→ ${prefix}translate <sigla/frase>*
║	ᐳ Traduza mensagens para outros idiomas.
║
║ *→ ${prefix}covid <País em Inglês>*
║	ᐳ Obtenha os casos do Covid-19.
║
║ *→ ${prefix}paises*
║	ᐳ Lista de países em inglês. 
║
║ *→ ${prefix}alarme*
║	ᐳ _Programe um alarme pra te lembrar.
║
║ *→ ${prefix}clima <cidade>*
║	ᐳ Saiba sobre o clima atual da sua cidade.
║
║ *→ ${prefix}maps <local>*
║	ᐳ Veja o mapa do local escolhido.
║
║ *→ ${prefix}wiki <assunto>*
║	ᐳ Pesquise na wikipédia.
║
║ *→ ${prefix}google <assunto>*
║	ᐳ Pesquise no goole.
║
║ *→ ${prefix}book <nome>*
║	ᐳ Pesquise sobre um Livro.
║
║ *→ ${prefix}profile*
║	ᐳ Veja seu perfil.
║
